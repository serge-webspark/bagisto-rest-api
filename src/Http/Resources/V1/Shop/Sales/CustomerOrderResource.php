...
final class CustomerOrderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'formatted_base_grand_total'              => core()->formatPrice($this->base_grand_total, $this->order_currency_code),
            ...
            'formatted_base_grand_total_invoiced'     => core()->formatPrice($this->base_grand_total_invoiced, $this->order_currency_code),
            ...
            'formatted_base_grand_total_refunded'     => core()->formatPrice($this->base_grand_total_refunded, $this->order_currency_code),
            ...
            'formatted_base_sub_total'                => core()->formatPrice($this->base_sub_total, $this->order_currency_code),
            'base_sub_total_incl_tax'                 => $this->base_sub_total_incl_tax,
            'formatted_base_sub_total_incl_tax'       => core()->formatPrice($this->base_sub_total_incl_tax, $this->order_currency_code),
            ...
            'formatted_base_sub_total_invoiced'       => core()->formatPrice($this->base_sub_total_invoiced, $this->order_currency_code),
            ...
            'formatted_base_discount_amount'          => core()->formatPrice($this->base_discount_amount, $this->order_currency_code),
            ...
            'formatted_base_discount_invoiced'        => core()->formatPrice($this->base_discount_invoiced, $this->order_currency_code),
            ...
            'formatted_base_discount_refunded'        => core()->formatPrice($this->base_discount_refunded, $this->order_currency_code),
            'tax_amount'                              => $this->tax_amount,
            'formatted_tax_amount'                    => core()->formatPrice($this->tax_amount, $this->order_currency_code),
            'base_tax_amount'                         => $this->base_tax_amount,
            'formatted_base_tax_amount'               => core()->formatPrice($this->base_tax_amount, $this->order_currency_code),
            ...
            'formatted_base_tax_amount_invoiced'      => core()->formatPrice($this->base_tax_amount_invoiced, $this->order_currency_code),
            ...
            'formatted_base_tax_amount_refunded'      => core()->formatPrice($this->base_tax_amount_refunded, $this->order_currency_code),
            ...
            'formatted_base_shipping_amount'          => core()->formatPrice($this->base_shipping_amount, $this->order_currency_code),
            'base_shipping_amount_incl_tax'           => $this->base_shipping_amount_incl_tax,
            'formatted_base_shipping_amount_incl_tax' => core()->formatPrice($this->base_shipping_amount_incl_tax, $this->order_currency_code),
            ...
            'formatted_base_shipping_invoiced'        => core()->formatPrice($this->base_shipping_invoiced, $this->order_currency_code),
            ...
            'invoices' => $this->invoices->map(static fn (Invoice $invoice): array => [
                'id' => $invoice->id,
            ]),
