...
class StaticPageController
{
     ...
     *      description="Returns static page list",
     *
     *      @OA\Parameter(
     *          name="sort",
     ...
     *                  type="array",
     *
     *                  @OA\Items(ref="#/components/schemas/StaticPageList")
     *              ),
     *
     *              @OA\Property(
     *                  property="meta",
     ...
     *      description="Returns static page by ID",
     *
     *      @OA\Parameter(
     *          name="id",
     ...
     *                  property="data",
     *                  type="object",
     *                  ref="#/components/schemas/StaticPageDetails"
     *              )
     *          )
     *      ),
     *
